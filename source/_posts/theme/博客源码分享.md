...
**目前有两个本仓库：纯主题仓库[hexo-theme-amazing](https://github.com/removeif/hexo-theme-amazing)、博客主题完整仓库[hexo-theme-icarus-removeif](https://github.com/removeif/hexo-theme-icarus-removeif)**
